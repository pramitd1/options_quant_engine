...
def build_signal_evaluation_row(
    ...
    *,
    ...
    row = {
        ...
        "heston_research_enabled": trade.get("heston_research_enabled"),
        "heston_calibration_status": trade.get("heston_calibration_status"),
        "heston_calibration_reason": trade.get("heston_calibration_reason"),
        "heston_calibration_sample_size": trade.get("heston_calibration_sample_size"),
        "heston_kappa": trade.get("heston_kappa"),
        "heston_theta": trade.get("heston_theta"),
        "heston_vol_of_vol": trade.get("heston_vol_of_vol"),
        "heston_rho": trade.get("heston_rho"),
        "heston_v0": trade.get("heston_v0"),
        "heston_calibration_error": trade.get("heston_calibration_error"),
        "heston_surface_quality": trade.get("heston_surface_quality"),
        "heston_quality_flags": trade.get("heston_quality_flags"),
        "heston_bound_hit_count": trade.get("heston_bound_hit_count"),
        "heston_tte_days": trade.get("heston_tte_days"),
        "heston_tte_bucket": trade.get("heston_tte_bucket"),
        "heston_expiry_context": trade.get("heston_expiry_context"),
        "heston_short_tte_guard": trade.get("heston_short_tte_guard"),
        "heston_selected_iv_quality": trade.get("heston_selected_iv_quality"),
        "heston_skew_state": trade.get("heston_skew_state"),
        "heston_forward_variance_proxy": trade.get("heston_forward_variance_proxy"),
        "heston_model_price": trade.get("heston_model_price"),
        "heston_model_delta": trade.get("heston_model_delta"),
        "heston_model_gamma": trade.get("heston_model_gamma"),
        "heston_model_iv_proxy": trade.get("heston_model_iv_proxy"),
        "bs_model_price_for_heston": trade.get("bs_model_price_for_heston"),
        "bs_vs_heston_price_gap": trade.get("bs_vs_heston_price_gap"),
        "heston_price_gap_rel_pct": trade.get("heston_price_gap_rel_pct"),
        "bs_vs_heston_greek_gap": trade.get("bs_vs_heston_greek_gap"),
        "greek_model_divergence_score": trade.get("greek_model_divergence_score"),
        "heston_diagnostics_json": trade.get("heston_diagnostics_json"),
