...
# ================================
# Research-only Heston Diagnostics
# ================================

# Heston remains disabled by default so the live Black-Scholes Greek path stays
# the production default. Enable only for research capture/replay diagnostics.
HESTON_RESEARCH_ENABLED = _env_flag("OQE_HESTON_RESEARCH_ENABLED", False)
HESTON_CALIBRATION_MAX_ROWS = _env_int("OQE_HESTON_CALIBRATION_MAX_ROWS", 80)
HESTON_CALIBRATION_MIN_ROWS = _env_int("OQE_HESTON_CALIBRATION_MIN_ROWS", 8)
HESTON_CALIBRATION_ERROR_REJECT = _env_float("OQE_HESTON_CALIBRATION_ERROR_REJECT", 0.35)
HESTON_CALIBRATION_TIMEOUT_SECONDS = _env_float("OQE_HESTON_CALIBRATION_TIMEOUT_SECONDS", 2.5)
HESTON_BOUND_GUARD_TOLERANCE_PCT = _env_float("OQE_HESTON_BOUND_GUARD_TOLERANCE_PCT", 0.01)
HESTON_BOUND_GUARD_REJECT_COUNT = _env_int("OQE_HESTON_BOUND_GUARD_REJECT_COUNT", 3)
HESTON_PRICE_GAP_WEAK_PCT = _env_float("OQE_HESTON_PRICE_GAP_WEAK_PCT", 60.0)
HESTON_PRICE_GAP_REJECT_PCT = _env_float("OQE_HESTON_PRICE_GAP_REJECT_PCT", 100.0)
HESTON_SHORT_TTE_WEAK_DAYS = _env_float("OQE_HESTON_SHORT_TTE_WEAK_DAYS", 1.0)
HESTON_SHORT_TTE_REJECT_DAYS = _env_float("OQE_HESTON_SHORT_TTE_REJECT_DAYS", 0.05)
HESTON_SELECTED_IV_LOW_PCT = _env_float("OQE_HESTON_SELECTED_IV_LOW_PCT", 3.0)
HESTON_SELECTED_IV_HIGH_PCT = _env_float("OQE_HESTON_SELECTED_IV_HIGH_PCT", 150.0)
...
def _validate_runtime_settings() -> None:
    ...
    positive_checks = {
        ...
        "HESTON_CALIBRATION_MAX_ROWS": HESTON_CALIBRATION_MAX_ROWS,
        "HESTON_CALIBRATION_MIN_ROWS": HESTON_CALIBRATION_MIN_ROWS,
        "HESTON_CALIBRATION_ERROR_REJECT": HESTON_CALIBRATION_ERROR_REJECT,
        "HESTON_CALIBRATION_TIMEOUT_SECONDS": HESTON_CALIBRATION_TIMEOUT_SECONDS,
        "HESTON_BOUND_GUARD_TOLERANCE_PCT": HESTON_BOUND_GUARD_TOLERANCE_PCT,
        "HESTON_BOUND_GUARD_REJECT_COUNT": HESTON_BOUND_GUARD_REJECT_COUNT,
        "HESTON_PRICE_GAP_WEAK_PCT": HESTON_PRICE_GAP_WEAK_PCT,
        "HESTON_PRICE_GAP_REJECT_PCT": HESTON_PRICE_GAP_REJECT_PCT,
        "HESTON_SHORT_TTE_WEAK_DAYS": HESTON_SHORT_TTE_WEAK_DAYS,
        "HESTON_SHORT_TTE_REJECT_DAYS": HESTON_SHORT_TTE_REJECT_DAYS,
        "HESTON_SELECTED_IV_LOW_PCT": HESTON_SELECTED_IV_LOW_PCT,
        "HESTON_SELECTED_IV_HIGH_PCT": HESTON_SELECTED_IV_HIGH_PCT,
    }
    ...
    if HESTON_CALIBRATION_MAX_ROWS < HESTON_CALIBRATION_MIN_ROWS:
        raise ValueError(
            "HESTON_CALIBRATION_MAX_ROWS must be >= HESTON_CALIBRATION_MIN_ROWS"
        )
    if HESTON_PRICE_GAP_REJECT_PCT < HESTON_PRICE_GAP_WEAK_PCT:
        raise ValueError(
            "HESTON_PRICE_GAP_REJECT_PCT must be >= HESTON_PRICE_GAP_WEAK_PCT"
        )
    if HESTON_SHORT_TTE_WEAK_DAYS < HESTON_SHORT_TTE_REJECT_DAYS:
        raise ValueError(
            "HESTON_SHORT_TTE_WEAK_DAYS must be >= HESTON_SHORT_TTE_REJECT_DAYS"
        )
    if HESTON_SELECTED_IV_HIGH_PCT <= HESTON_SELECTED_IV_LOW_PCT:
        raise ValueError(
            "HESTON_SELECTED_IV_HIGH_PCT must be > HESTON_SELECTED_IV_LOW_PCT"
        )
