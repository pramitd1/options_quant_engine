...
TRADE_RUNTIME_THRESHOLDS = {
    ...
    # Expiry-aware degraded execution override for repeated provider-health
    # caution/weak blocks under realistic near-expiry microstructure stress.
    ...
    "provider_health_override_min_effective_priced_ratio": 0.45,
    "provider_health_override_max_proxy_ratio": 1.00,
    ...
    "provider_health_override_one_sided_quote_ratio_max": 1.00,
    ...
    "regime_negative_gamma_position_size_mult": 0.85,
