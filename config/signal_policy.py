...
TRADE_RUNTIME_THRESHOLDS = {
    ...
    "move_probability_score_cap": 72,
    "composite_weight_trade_strength": 0.55,
    "composite_weight_move_probability": 0.15,
    ...
    "high_composite_soft_override_require_confirmed_status": 1,
    "high_composite_soft_override_allowed_data_quality_statuses": ["GOOD", "STRONG", "CAUTION"],
    "high_composite_soft_override_size_cap": 0.65,
    "high_composite_soft_override_hold_cap_minutes": 35,
    "enable_underlying_exit_plan": 1,
    "underlying_exit_plan_min_delta": 0.08,
    "underlying_exit_plan_fallback_delta": 0.45,
    "underlying_exit_plan_profit_expected_move_cap": 0.85,
    "underlying_exit_plan_stop_expected_move_cap": 0.45,
    "underlying_exit_plan_zone_buffer_pct_of_expected_move": 0.08,
    "underlying_exit_plan_min_buffer_points": 12,
    "underlying_exit_plan_max_buffer_points": 45,
    ...
    "preferred_intraday_exit_cap_minutes": 75,
    "positive_gamma_risk_off_hold_cap_minutes": 60,
    "fragile_risk_off_hold_cap_minutes": 45,
    ...
    "provider_health_override_high_efficiency_strength_buffer": 0,
    "provider_health_override_min_composite_buffer": 0,
    "provider_health_override_min_option_efficiency_score": 80,
    "provider_health_override_min_premium_efficiency_score": 70,
    ...
    "weak_data_circuit_breaker_hidden_fragility_min_trigger_count": 3,
    # Historical outcome guard: use recent regime-matched evaluation history to
    # downgrade setups that repeatedly decay, stop out, or fail to hold edge.
    "enable_historical_outcome_guard": 1,
    "historical_outcome_guard_min_samples": 12,
    "historical_outcome_guard_min_tradeability_score": 55.0,
    "historical_outcome_guard_min_session_close_bps": -5.0,
    "historical_outcome_guard_early_decay_share_threshold": 0.55,
    ...
    "session_risk_lookback_signals": 6,
    "session_risk_min_samples": 4,
    "session_risk_max_stopout_streak": 2,
    "session_risk_max_loss_share": 0.60,
    "session_risk_min_avg_close_bps": -5.0,
    "session_risk_caution_size_cap": 0.60,
    "session_risk_block_size_cap": 0.35,
    "session_risk_hold_cap_minutes": 25,
    "session_risk_cooldown_minutes": 30,
    # Trade-slot governor: cap the number of same-day active ideas per symbol
    # and allow only tightly constrained operator overrides.
    "enable_trade_slot_governor": 1,
    "trade_slot_lookback_signals": 6,
    ...
    "trade_slot_hold_cap_minutes": 20,
    "trade_slot_override_hold_cap_minutes": 15,
    "enable_operator_override_controls": 1,
    # Trade-promotion governor: require clean confirmation and replay/live
    # validation evidence before promoting a marginal setup to TRADE.
    ...
    # Portfolio concentration guard: treat recent same-way options suggestions
    # as a book and throttle crowding before it turns into correlated exposure.
    "enable_portfolio_concentration_guard": 1,
    "portfolio_concentration_lookback_signals": 6,
    "enable_portfolio_allocation_ladder": 1,
    "portfolio_priority_high_threshold": 75,
    "portfolio_priority_medium_threshold": 60,
    "portfolio_priority_low_threshold": 45,
    "portfolio_allocation_core_fraction_max": 0.25,
    "portfolio_allocation_tactical_fraction_max": 0.15,
    "portfolio_allocation_small_fraction_max": 0.08,
    "portfolio_allocation_probe_fraction_max": 0.04,
    "portfolio_allocation_medium_mult": 0.75,
    "portfolio_allocation_low_mult": 0.50,
    "portfolio_allocation_probe_mult": 0.25,
    "portfolio_heat_hot_allocation_cap": 0.55,
    "portfolio_heat_critical_allocation_cap": 0.35,
    "portfolio_heat_cool_priority_bonus": 4,
    "premium_preference_low_pct_of_spot": 0.50,
    "premium_preference_high_pct_of_spot": 1.00,
    "premium_preference_bonus": 6,
    "premium_expense_priority_penalty": 8,
    "premium_efficiency_low_threshold": 55,
    "premium_efficiency_high_threshold": 75,
    "premium_efficiency_priority_bonus": 3,
    "premium_efficiency_priority_penalty": 6,
    "premium_expense_size_cap": 0.65,
    "signal_probability_neutral_shrink": 0.12,
    "signal_probability_fragile_shrink_add": 0.12,
    "signal_probability_risk_off_shrink_add": 0.06,
    "signal_probability_fragile_ceiling": 0.74,
    "signal_probability_live_calibration_caution_shrink_add": 0.05,
    "signal_probability_live_calibration_block_shrink_add": 0.10,
    "signal_probability_live_directional_caution_shrink_add": 0.05,
    "signal_probability_live_directional_block_shrink_add": 0.10,
    "signal_probability_live_calibration_max_ece": 0.18,
    "signal_probability_live_calibration_max_top_decile_overconfidence": 0.20,
    "signal_probability_proxy_ratio_caution": 0.50,
    "signal_probability_proxy_ratio_high": 0.80,
    "signal_probability_proxy_ratio_caution_shrink_add": 0.04,
    "signal_probability_proxy_ratio_high_shrink_add": 0.08,
    "signal_probability_option_efficiency_unavailable_shrink_add": 0.05,
    "trade_promotion_proxy_ratio_max": 0.50,
    "portfolio_heat_hot_priority_penalty": 8,
    "portfolio_heat_critical_priority_penalty": 16,
    ...
    "reversal_warning_vote_count_floor": 2,
    "reversal_warning_breakout_evidence_high": 1.5,
    "reversal_warning_head_confidence_floor": 0.60,
    "signal_probability_early_reversal_shrink_add": 0.06,
    "signal_probability_unresolved_reversal_shrink_add": 0.08,
    "signal_probability_early_reversal_ceiling": 0.68,
    "trade_promotion_block_early_reversal": 1,
    "trade_promotion_early_reversal_requires_strong_confirmation": 1,
