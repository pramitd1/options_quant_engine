...
EXECUTION_TRADE_KEYS = [
    ...
    "advisory_only",
    "advisory_lots",
    "advisory_capital_required",
    "advisory_position_size_multiplier",
    "max_affordable_lots",
    "budget_ok",
    ...
    "regime_segment_hit_rate_60m",
    "regime_segment_avg_60m_bps",
    "regime_segment_avg_close_bps",
    "regime_segment_avg_tradeability_score",
    "historical_outcome_samples",
    "historical_best_horizon",
    "historical_exit_bias",
    "historical_avg_60m_bps",
    ...
    "session_risk_budget_remaining_pct",
    "session_risk_cooldown_active",
    "trade_slot_governor",
    "trade_slot_active_signal_count",
    "trade_slot_same_direction_count",
    "operator_override_active",
    "operator_override_reason",
    "operator_override_mode",
    "portfolio_concentration_guard",
    "portfolio_concentration_recent_signal_count",
    "portfolio_concentration_same_direction_count",
    "portfolio_concentration_same_direction_share",
    "portfolio_book_heat_score",
    "portfolio_book_heat_label",
    "portfolio_priority_score",
    "portfolio_priority_bucket",
    "portfolio_allocation_tier",
    "portfolio_capital_fraction_max",
    "iv_hv_regime",
    "iv_hv_spread",
