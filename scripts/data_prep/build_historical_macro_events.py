...
Usage:
    python scripts/data_prep/build_historical_macro_events.py
    python scripts/data_prep/build_historical_macro_events.py --from-year 2015
    python scripts/data_prep/build_historical_macro_events.py --to-year 2025
    python scripts/data_prep/build_historical_macro_events.py --validate
"""
...
def main():
    ...
    output = {
        ...
        "generated_by": "scripts/data_prep/build_historical_macro_events.py",
