...
-----
  ...
  # Simulate a specific regime only
    python scripts/simulations/simulate_regime_signals.py --regime RISK_ON
  ...
  # Use a custom scenario JSON file
    python scripts/simulations/simulate_regime_signals.py --scenario-file config/my_scenarios.json

  # Dry run — show what would be simulated without writing to the dataset
    python scripts/simulations/simulate_regime_signals.py --dry-run
"""
