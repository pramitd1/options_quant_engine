...
Usage:
    python scripts/historical_global_market_download.py               # download all
    python scripts/historical_global_market_download.py --ticker oil  # single ticker
    python scripts/historical_global_market_download.py --list        # show tickers
    python scripts/historical_global_market_download.py --features-only  # recompute features from cached raw data
    python scripts/historical_global_market_download.py --max-years 10   # limit lookback
"""
